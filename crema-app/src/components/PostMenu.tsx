            ...
            >
              ...
              {onHide && (
                <>
                  ...
                  <Pressable onPress={() => { setOpen(false); onHide(); }} style={({ pressed }) => [s.menuItem, pressed && s.menuItemPressed]}>
              ...
              {onReport && (
                <>
                  ...
                  <Pressable onPress={() => { setOpen(false); onReport(); }} style={({ pressed }) => [s.menuItem, pressed && s.menuItemPressed]}>
              ...
              {onDislike && (
                <>
                  ...
                  <Pressable onPress={() => { setOpen(false); onDislike(); }} style={({ pressed }) => [s.menuItem, pressed && s.menuItemPressed]}>
