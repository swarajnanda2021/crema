...
const SECTION_BLURB: Record<CatalogOpsSection, string> = {
  ...
  log: "Daily journal of what the autonomous catalog-ops agents did. Each row is one agent session — task, narrative summary, outcome, roasters touched. Click into an entry for the underlying MCP tool-call trail.",
